...
module.exports = prepareEmails;

function prepareEmails(resultsPerUser) {
  return resultsPerUser.map(prepareEmailBodies);
}

function prepareEmailBodies(userResults) {
  userResults.results = {
    html: formatAsHTML(userResults.results),
    text: JSON.stringify(userResults.results)
  };
